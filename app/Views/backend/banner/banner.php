...
<body>
    ...
    <?php if (!empty($search)) : ?>
        <a href="<?= site_url('/banner') ?>" class="btn  btn-sm custom-btn">Volver</a>
    <?php endif; ?>
    <a href="<?= site_url('/banner_eliminados') ?>" class="btn  btn-sm custom-btn">Eliminados</a>
</section>
